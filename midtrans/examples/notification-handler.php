...
if ($transaction == 'capture') {
    ...
    $sql = "UPDATE pesanhomestay SET StatusPayment = 'success' WHERE Id = '$order_id'";
    ...
    include '../../config/config.php';
    $sql = "UPDATE pesanhomestay SET StatusPayment = 'cancel' WHERE Id = '$order_id'";
    $query = mysqli_query($conn, $sql);
    echo "Payment using " . $type . " for transaction order_id: " . $order_id . " is denied.";
} else if ($transaction == 'expire') {
    include '../../config/config.php';
    $sql = "UPDATE pesanhomestay SET StatusPayment = 'expire' WHERE Id = '$order_id'";
    $query = mysqli_query($conn, $sql);
